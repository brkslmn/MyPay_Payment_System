...
<head runat="server"> 
    ...
    <!-- DEMO CHARTS -->
    <link rel="stylesheet" href="Temp/grains-master/public/demo/chartist.css"/>
    <link rel="stylesheet" href="Temp/grains-master/public/demo/chartist-plugin-tooltip.css"/>
    ...
    <nav class="navbar flex-nowrap p-0">
        <div class="navbar-brand-wrapper d-flex align-items-center col-auto">
            ...
            <a class="navbar-brand navbar-brand-mobile" href="/">
                <img class="img-fluid w-100" src="Temp/grains-master/public/img/logo-mini.png" alt="Graindashboard"/>
            </a>
            <!-- End Logo For Mobile View -->

            <!-- Logo For Desktop View -->
            <a class="navbar-brand navbar-brand-desktop" href="/">
                <img class="side-nav-show-on-closed" src="Temp/grains-master/public/img/logo-mini.png" alt="Graindashboard" style="width: auto; height: 33px;"/>
                <img class="side-nav-hide-on-closed" src="Temp/grains-master/public/img/logo.png" alt="Graindashboard" style="width: auto; height: 33px;"/>
            </a>
    ...
    <aside id="sidebar" class="js-custom-scroll side-nav">
        <ul id="sideNav" class="side-nav-menu side-nav-menu-top-level mb-0">
            ...
            <li class="side-nav-menu-item">
                <a class="side-nav-menu-link media align-items-center" href="Temp/documentation/" target="_blank">
              <span class="side-nav-menu-icon d-flex mr-3">
                <i class="gd-file"></i>
              </span>
                ...
                <div class="col-md-6 col-xl-4 mb-3 mb-md-4">
                    ...
                    <div class="card h-100">
                        <div class="card-header d-flex">
                            <h5 class="h6 font-weight-semi-bold text-uppercase mb-0"><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></h5>
                        </div>
                        <div class="card-body p-0">
...
<script src="Temp/grains-master/public/graindashboard/js/graindashboard.js"></script>
<script src="Temp/grains-master/public/graindashboard/js/graindashboard.vendor.js"></script>

<!-- DEMO CHARTS -->
<script src="Temp/grains-master/public/demo/resizeSensor.js"></script>
<script src="Temp/grains-master/public/demo/chartist.js"></script>
<script src="Temp/grains-master/public/demo/chartist-plugin-tooltip.js"></script>
<script src="Temp/grains-master/public/demo/gd.chartist-area.js"></script>
<script src="Temp/grains-master/public/demo/gd.chartist-bar.js"></script>
<script src="Temp/grains-master/public/demo/gd.chartist-donut.js"></script>
<script>
